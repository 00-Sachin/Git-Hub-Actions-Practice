...
Because this project uses automated CI/CD, the latest version of the application is always available on Docker Hub. You can we pull and run the live container on any machine using the following command:
